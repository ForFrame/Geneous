...
public class SchoolLevel2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_school_level2);
	...
	void schoolLevel2(){
		...
		Animation myFadeInAnimation = AnimationUtils.loadAnimation(SchoolLevel2.this, R.anim.tween);
		...
		CountTable.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(SchoolLevel2.this,L1ScCount.class);
				startActivity(intent);
			}
		});*/
		...
		GameBoard.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(SchoolLevel2.this,L1ScLongShort.class);
				startActivity(intent);
			}
		});*/
