...
public class MkL1BestFood extends Activity {
...
@Override
	...
	void game007(){
		...
		LogoutButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {	
				...
				instructPage.stop();
				Intent intent = new Intent(MkL1BestFood.this,Main.class);
	...
	int choice(int random){
	    ...
	    if(random == 1){
			...
			ans2.setBackgroundResource(R.drawable.ml1_choice4_2);
		}
		else if(random == 5){
			answer = 2;
			...
			answer = 2;
			ans1.setBackgroundResource(R.drawable.ml1_choice6_1);
	...
	protected void showPopup(int scores){
		...
		dialogNextBt.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				// TODO Auto-generated method stub
				dialog.dismiss();
				Intent intent = new Intent(MkL1BestFood.this,MkL2Money.class);
				startActivity(intent);
