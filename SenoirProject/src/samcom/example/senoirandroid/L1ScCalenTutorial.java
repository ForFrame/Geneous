...
public class L1ScCalenTutorial extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Animation myFadeOnceAnimation = AnimationUtils.loadAnimation(L1ScCalenTutorial.this, R.anim.tween_once);
