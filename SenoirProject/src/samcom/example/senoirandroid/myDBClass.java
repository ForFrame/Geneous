...
//TODO Auto-generated method stub
	...
	try{
		...
		String[] gameName = {"เน€เธ�เธกเธชเน�เธกเธฒเธ�เธฑเธ�เน�เธ•เน�เธฐเธ�เธฑเธ�เน€เธ–เธญเธฐ","เน€เธ�เธกเธชเน�เธชเธตเธ�เธฃเธฐเธ�เธณเธงเธฑเธ�เธ—เธฑเน�เธ� 7 เธชเธตเธกเธตเธญเธฐเน�เธฃเธ�เน�เธฒเธ�เธ�เน�เธฒ","เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธ�เธ�เธฒเธ”เธชเธฑเน�เธ�-เธขเธฒเธงเธ�เธฑเธ�เน€เธ–เธญเธฐ","เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธ�เธฒเธฃเน�เธ�เน�เธ–เธ�เธ�เธ�เธฑเธ�เน€เธ–เธญเธฐ",
							"เน�เธ�เธฅเน�-เน�เธ�เธฅเธ�เธทเธญเธญเธฐเน�เธฃเธ�เน�เธฒ","เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธขเธฒเธ�เธ�เธฒเธซเธ�เธฐเธ�เธฃเธฐเน€เธ เธ—เธ•เน�เธฒเธ�เน�เธ�เธฑเธ�เน€เธ–เธญเธฐ","เธกเธฒเธ�เธฑเธ�เน€เธซเธฃเธตเธขเธ�เธ�เธฑเธ�เน€เธ–เธญเธฐ","เธ�เธงเธฃเน€เธฅเธทเธญเธ�เธฃเธฑเธ�เธ�เธฃเธฐเธ—เธฒเธ�เธญเธฒเธซเธฒเธฃเธญเธฐเน�เธฃเธ”เธตเธ�เน�เธฒ",
							"เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธ�เธฒเธฃเน�เธ�เน�เน€เธ�เธดเธ�เธ�เธฑเธ�เน€เธ–เธญเธฐ","เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธ�เธฒเธฃเธ�เธฑเธ�เน€เธฅเธ�เน�เธฅเธฐเธชเธตเธ•เน�เธฒเธ�เน�เธ�เธฑเธ�เน€เธ–เธญเธฐ","เน€เธ�เธฃเธทเน�เธญเธ�เน�เธ�เน�เน�เธ�เธ�เน�เธฒเธกเธตเธ�เธฃเธฐเน�เธขเธ�เธ�เน�เธขเธฑเธ�เน�เธ�เธ�เน�เธฒ","เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธญเธฒเธ�เธตเธ�เน�เธ�เธ�เธธเธกเธ�เธ�เธ�เธญเธ�เน€เธฃเธฒเธ�เธฑเธ�เน€เธ–เธญเธฐ",
							"เธกเธฒเธฃเธนเน�เธ�เธฑเธ�เธฃเน�เธฒเธ�เธ�เธฒเธฃเธ�เธญเธ�เน€เธฃเธฒเธ�เธฑเธ�เน€เธ–เธญเธฐ","เน€เธกเธทเน�เธญเน€เธฃเธฒเธ�เน�เธงเธขเธ�เธงเธฃเธ—เธณเธขเธฑเธ�เน�เธ�เน€เธญเน�เธข","เน�เธ•เน�เธฅเธฐเธคเธ”เธนเธ•เน�เธฒเธ�เธ�เธฑเธ�เธขเธฑเธ�เน�เธ�เธ�เน�เธฒ","เธกเธฒเธ�เธฑเธ�เธ�เธณเธ�เธงเธ�เธชเธฑเธ•เธงเน�เธ�เธฑเธ�เน€เธ–เธญเธฐ","เน€เธ�เธฒเธ�เธตเน�เน€เธ�เน�เธ�เธ�เธญเธ�เน�เธ�เธฃเธ�เน�เธฒ","เธฃเธนเน�เน�เธซเธกเน€เธญเน�เธขเธงเน�เธฒเธชเธฑเธ•เธงเน�เธกเธตเธ�เธตเน�เธ�เธฃเธฐเน€เธ เธ—"};
		int level=1;
