...
public class SelectMarketLevel extends Activity {
	...
	void selectLevel(){
		...
		Lv1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				instructPage.stop();
				Intent intent = new Intent(SelectMarketLevel.this,MarketLevel1.class);
				startActivity(intent);
			}
		});
		...
		Lv2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				instructPage.stop();
				Intent intent = new Intent(SelectMarketLevel.this,MarketLevel2.class);
				startActivity(intent);
			}
		});
		...
		Lv3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				instructPage.stop();
				Intent intent = new Intent(SelectMarketLevel.this,MarketLevel3.class);
				startActivity(intent);
			}
		});
