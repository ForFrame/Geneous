...
public class HsL1Shape extends Activity {
...
@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.house_l1_shape);
		...
		//mediaPlayer.start();
		Round = myDb.getNumRound("010", username);
	...
	void checkAnswer(final int RandomNum,final int item){
				...
				Answer1.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						...
						if(answer == 1){
							...
							soundCorrect.start();
							myDb.addItemScore("010",username,Round,item,1,(countTime - timeRemain));
							...
							countdownTime.cancel();
							soundWrong.start();
							myDb.addItemScore("010",username,Round,item,0,(countTime - timeRemain));
						}
		...
		final Animation myFadeonceAnimation = AnimationUtils.loadAnimation(HsL1Shape.this, R.anim.tween_once);
		...
		Button HelpButton = (Button)findViewById(R.id.shapeHelp);
		...
		Button HomeButton = (Button)findViewById(R.id.shapebackHome);
	...
	int choice(int random){
		...
		AbsoluteLayout Thislayout=(AbsoluteLayout)findViewById(R.id.shapeLayout);
		int answer=0;
		Random randomGenerator = new Random();
	...
	void showTimeout(){
		...
		myDb.close();
		myDb.getWritableDatabase();
		myDb.addItemScore("010",username,Round,item,0,startTime/1000);
	...
	protected void showBeginPopup(){
		...
		BeginPop.setContentView(R.layout.house_l1_shape_tutorial);
		...
		final ImageView instruct = (ImageView)BeginPop.findViewById(R.id.helpshape);
